...
search_functions = 'inurl: allinurl:'
new_sf = "key * site"
default_domain_extensions = 'ca,co.ca,com,net,org,web,info,gov,edu,co,us,uk,it,fr,de,id,co.us,co.uk,co.it,co.fr,co.de,co.id'
